...
### (So it actually does your work while you step away)
...
2. Send it to anyone asking you about Claude but "I've never tried it."
...
This sounds like a small thing. It isn't. It's the difference between AI as a tool you talk to and a collaborator that works in your environment.
...
- **about-me.md** — who you are, what you do, your role, what good work looks like in your work
...
Here's what every other AI does when you give it an unclear task: it guesses. Confidently. It picks an interpretation, gives you a polished output that answers the wrong question.
...
> DO NOT start executing yet. Ask me clarifying questions (use AskUserQuestion) to refine the approach. Only begin work once we've aligned.
...
> /data:explore I've uploaded a CSV. Give me a summary of what's in it, flag any anomalies, and suggest three analyses worth running.
...
Cowork is the best AI tool I've used for knowledge work. It is not perfect. Here's where I've personally hit friction:
...
> Read all the files in this folder. Then help me [your actual task].
> Before you start — ask me clarifying questions so we can make sure you're headed in the right direction.
...
Install it. Type "/" in a new Cowork chat to see the slash commands it adds. Try one. See what the output looks like with a specialist plugin active versus a generic prompt.
...
The people I see getting the most from AI aren't the ones with the cleverest prompts. They're the ones who built systems. Files that store their context. Instructions that persist across sessions. Plugins that handle specialized work. A setup that gets better every week.
