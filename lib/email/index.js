...
import { setPasswordEmail, resetPasswordEmail } from "./templates.js";
 ...
 *
 * There is deliberately NO production fallback. The obvious guess would be
 * duckaroo.com.au — it is metadataBase in app/layout.js — but that domain is
 * still served by the old Shopify store, so a guessed link would send customers
 * to a 404 and silently break the whole migration. Set APP_URL to wherever this
 * app is actually reachable (duckaroo.vercel.app today, duckaroo.com.au once
 * DNS moves).
 */
