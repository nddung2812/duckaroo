...
/**
 * Batch lookup for checkout: the server recomputes order totals from these
 * rows so the client can never dictate a price.
 */
export async function getStockItemsByIds(ids) {
